      ...
      <>
        <p className={css['detail']}>
          <span>
            ...
            <div>
            - Research new technology platform and use for creating cross-platform for Mobile Apps.
            </div>
            <div>
            - Support and handle technical problems when problems arise in the project.
            </div>
            <div>
            - Supporting for new members. 
            </div>
          </span>
        </p>
        <p className={css['detail']}>
          <span>
            ...
            <br />• <b>CHIS</b> for <b>for USAID (United States Agency of International Development) </b>to manage HIV information, Treatment and Communication in Examination .
          </span>
        </p>
      </>
    ),
